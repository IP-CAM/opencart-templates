...
<h4 align="justify">How to add a new TemplateMonster Deal Banner module</h4>
<p>Navigate to <strong>Extensions</strong> &gt; <strong>Extensions</strong>.</p>
<p>
  <figure class="img-polaroid"> <img src="img/edit-parallax-1.jpg" alt=""/></figure>
</p>
...
<p>Find the <strong>Template Monster Layout Builder</strong> section. Navigate to the<strong> Home Page</strong> module and press the edit button.</p>
<p>
...
<p>We have added the <strong>New  TemplateMonster Deal Banner </strong>module.</p>
<p>
...
<h4>How to assign the new TemplateMonster Deal Banner module to any layout (via Layouts)</h4>
...
<p align="justify">Choose the page (layout) you want the New  TemplateMonster Deal Banner module place on and press the edit button in the corresponding field in the action column.</p>
<p>
