...
<ol class="marked-list">
    ...
    <li>
        <p>Представление в виде Коллекции.</p>
        <figure class="img-polaroid">
...
<h5>Связь продуктов с картинкой коллекции, добавление области выделения продукта:</h5>
<p>Для того чтобы добавить продукт в коллекцию, выберите его в поле Products:</p>

<figure class="img-polaroid">
    <img src="img/edit-collection_add_product.jpg" alt=""/>
</figure>

<p>Чтобы отметить выбранные продукты на картинке, нажмите кнопку "Add Image Map":</p>
...
<p>Создаваемые области выделения могут быть трех разных форм: квадрат, круг, и сложной (полигональной) формы.</p>
