...
<figure class="img-polaroid"> <img src="img/layout-5.jpg" alt=""/></figure>
<h5>Module basic settings:</h5>
<ol class="index-list">
	<li>
...
<ol class="marked-list">
  <li>
    <p>Press <strong>Add Column</strong>. After clicking this button you will be able to add rows. This option has several sections available:</p>
  ...
  <li>
    <p>Use the <strong>Delete</strong> button to remove column you don&rsquo;t need.</p>
  </li>
  <li>
...
<p align="justify">After setting up all the rows, columns and modules, save the Builder module and display it in one of the positions on the store main page.</p>