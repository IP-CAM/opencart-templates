...
<p align="justify">Данный тип установки используется, если у вас нет готового сайта OpenCart. Архив
    '<strong>themeXXX(full).zip</strong>' включает установочные файлы движка OpenCart и <strong>темы с демо-данными</strong>,
    поэтому вам не нужно отдельно загружать все установочный файлы движка OpenCart. Демо-данные позволят
    вашему сайту выглядеть идентично шаблону на странице предпросмотра, со всеми
...
<p align="justify">В случае возникновения сложностей при создании базы данных, необходимо обратиться к
...
<li>Откройте папку шаблона.</li>
    ...
    <li>Задайте правильные разрешения на следующие папки и файлы движка OpenCart:
        ...
        <p align="justify">Разрешения должны быть CHMOD 755 или 777 в зависимости от конфигурации
...
<p align="justify">Это заключительный этап установки движка OpenCart. Предлагаются две опции:
