...
<p align="justify">The modification allows you to add banner description. In order to turn the modification off or remove it, navigate to
...
<p>Some of the modules include a field to select a banner. Navigate to <strong>Design</strong> &gt; <strong>Banners</strong> section.</p>
...
<p>To create a new banner, click <strong>Add New</strong>. </p>
<figure class="img-polaroid">
  <img src="img/banner-1.jpg" alt=""/>
</figure>
<p>To edit
  existing banner, click <strong>Edit</strong>.</p>
  <figure class="img-polaroid">
    <img src="img/banner-2.jpg" alt=""/>
</figure>
<p>You will see the where you should enter
...
<li><strong>Banner Name</strong>;</li>
    ...
    <li>
      <div align="justify"><strong>Link</strong> — specify a link relative to the site URL (for example,
