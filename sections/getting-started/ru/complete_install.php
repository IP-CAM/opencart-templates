...
<p>Установка завершена. Чтобы открыть магазин, пропишите <strong> свое доменное
    ...
    <p class="alert alert-danger">Во избежание кражи шаблона, после его установки на сервер, необходимо проверить, закрыт ли доступ на прямое скачивание файлов с сервера. Для этого необходимо открыть файл .htaccess. и убедиться, что в нем есть следующий код:
