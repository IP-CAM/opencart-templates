            ...
            <ul>
                ...
                <li class="folder">
                    <dl class="inline-term">
                        ...
                        <dd> template archive without sample data files (for the installation over existing store);
                        </dd>
                    </dl>
                </li>
                <li class="folder">
                    <dl class="inline-term">
                        <dt>
                            <i class="fa fa-file"></i>
                            themeXXX(extensions).zip
                        </dt>
                        <dd> archive with the xml-files;</dd>
                    </dl>
                </li>
            </ul>
        </li>
            ...
            <ul>
                <li class="folder">
                    <dl class="inline-term">
                        ...
                        <dd> Adobe Photoshop source files (.psd);</dd>
                    </dl>
                </li>
                <li class="folder">
                    <dl class="inline-term">
