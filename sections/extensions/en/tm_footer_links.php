...
<p>Find the <strong>Olark Live Chat </strong>section. Press the <strong>edit</strong> button to configure the existing module.</p>
...
<p>You will be brought to the settings window:</p>
<figure class="img-polaroid"> <img src="img/olark-view-5.jpg" alt=""/></figure>
