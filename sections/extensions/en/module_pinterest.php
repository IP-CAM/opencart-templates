...
<p align="justify"><strong>TemplateMonster Pinterest</strong> module allows displaying Pinterest gallery on your store. This one Module can help you to display Pinterest Profile Pins or Board Pins. Width and Height can be scalable.</p>
...
<h4 align="justify">How to manage TemplateMonster Pinterest module</h4>
...
<p>Find the <strong>TemplateMonster Pinterest</strong><strong> </strong>section. Press <strong>edit</strong> button to configure the existing module.</p>
...
<ul class="marked-list">
  ...
  <li><strong>Pinterest Page URL </strong>— full path to the page that display the gallery;</li>
...
<h4 align="justify">How to add a new TemplateMonster Pinterest module</h4>
<p>Navigate to <strong>Extensions</strong> &gt; <strong>Extensions</strong>.</p>
<p>
  <figure class="img-polaroid"> <img src="img/edit-parallax-1.jpg" alt=""/></figure>
</p>
...
<p align="justify">Find the <strong>TemplateMonster Pinterest </strong>section. Press<strong> Add New </strong>button to create a new module.</p>
<p align="justify" class="alert alert-info">Use <strong>Ctrl+F</strong> to simplify the search process.</p>
<p>
...
<ul class="marked-list">
  ...
  <li><strong>Pinterest Page URL </strong>—  specify the full path to the page that display the gallery;</li>
...
<h4 align="justify">How to assign the new  TemplateMonster Pinterest module to the Home Page (via Layout Builder)</h4>
...
<p>Chose the position where you want to place the <strong>New  TemplateMonster Pinterest</strong> module. You can add row or column, if you want.</p>
<p>
...
<p> In the pop-up window choose the <strong>TemplateMonster Pinterest </strong>module to add. </p>
<p align="justify" class="alert alert-info">Use <strong>Ctrl+F</strong> to simplify the search process.</p>
<p>
  <figure class="img-polaroid"> <img src="img/tm-pinterest-edit-5.jpg" alt=""/></figure>
</p>
<p>We have added the <strong>New  TemplateMonster Pinterest</strong> module.</p>
<p>
...
<h4>How to assign the new TemplateMonster Pinterest module to any layout (via Layouts)</h4>
...
<p align="justify">Choose the page (layout) you want the <strong>New  Pinterest</strong> module place on and press the edit button in the corresponding field in the action column.</p>
<p>
