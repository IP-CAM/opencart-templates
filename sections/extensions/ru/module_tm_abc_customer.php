...
<p>Модуль предназначен для назначения скидок клиентам разных групп, при этом клиенту пересчитывается сумма заказа при
	его оформлении, с учетом скидки в процентах, заданной для конкретной группы клиентов.</p>
...
<ol class="index-list">
	...
	<li>
		<dl class="inline-term">
			<dt>Description</dt>
			<dd>Описание клиентской группы;</dd>
		</dl>
	</li>
	<li>
		<dl class="inline-term">
...
<h4>Настройки скидки для групп клиентов:</h4>

<figure class="img-polaroid"><img
		src="img/edit-order-totals.png" alt=""></figure>

<ol class="index-list">
	<li>
		<dl class="inline-term">
			<dt>Customers Discount</dt>
			<dd>Скидки клиентам в процентах;</dd>
		</dl>
	</li>
	<li>
		<dl class="inline-term">
