...
<h5>Megamenu configuration</h5>
<ol class="index-list">
    <li>
        <p>Megamenu items. Main items in the menu root. </p>
        ...
        <p>On the next page you will be able to create, remove and edit menu items.</p>
        <p class="alert alert-info"> Attention: This module supports multilanguage, so you can configure it for each shop language separately.</p>
    </li>
