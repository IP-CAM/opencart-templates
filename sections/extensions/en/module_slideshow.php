...
<p>This module allows you to display Camera slideshow on your website. </p>

<p>When the module is installed, you can configure it on the module configuration page.</p>
<h4 align="justify">How to manage TemplateMonster Slideshow module</h4>
...
<ul class="marked-list">
  ...
  <li><strong>Width</strong> — the pixel width of the block;
  ...
  <li><strong>Mousewheel release on edges</strong> — allow page scrolling when swiper is on edge positions (in the beginning or in the end);</li>
  <li><strong>Next Button</strong> — if true, the &quot;Next&quot; button will be displayed;</li>
  <li><strong>Prev Button</strong> — if true, the &quot;Prev&quot; button will be displayed;</li>
  <li><strong>Pagination</strong> —  if true, the slides pagination will be displayed;</li>
  <li><strong>Scrollbar</strong> —  if true, the Scrollbar will be displayed;</li>
  <li><strong>Loop</strong> — if true, continuously loop from the last slide to the first slide.</li>

  <h5>
    <p>Slides settings</p></h5>
  <p>You can create a new slide by pressing the &quot;<strong>Add Slide</strong>&quot; button.</p>
  <figure class="img-polaroid">
...
<li><p><strong>Slide type </strong> — choose a slide type (image or video);</p></li>
...
<h4 align="justify">How to add a new TemplateMonster Slideshow module</h4>
<p>Navigate to <strong>Extensions</strong> &gt; <strong>Extensions</strong>.</p>
<p>
  <figure class="img-polaroid"> <img src="img/edit-parallax-1.jpg" alt=""/></figure>
</p>
...
<ul class="marked-list">
  ...
  <p>Delete the slide pressing the &quot;<strong>Remove Slide</strong>&quot;</p><figure class="img-polaroid">
  <img src="img/slideshow-7.jpg" alt=""/>
</figure>
<li><p><strong>Slide type </strong> — choose a slide type (image or video);</p></li>
<p><strong>Image:</strong></p>
...
<h4>How to assign the new TemplateMonster Slideshow module to any layout (via Layouts)</h4>
