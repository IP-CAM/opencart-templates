...
<li>
    ...
    <li>
            ...
            <strong>Category</strong>
             — allows you to select the existing product category;
        
</li>
    <li>
        
            <strong>Tabs</strong>
             —  enables/disables tab view. If disabled, there is an option to select module view type;
  ...
  <ul class="marked-list">
    ...
    <li>
            ...
            <strong>Specials</strong>
             —  enables/disables Specials module;
        
</li>
    <li>
        
            <strong>Bestsellers</strong>
             —  enables/disables Bestsellers module;
        
</li>
    <li>
        
            <strong>Featured</strong>
             —  enables/disables Featured module;
        
</li>
    <li>
        
            <strong>Latest</strong>
             —  enables/disables Latest module;
        
    </li>
    <li>
        
            <div align="justify"><strong>Featured Products</strong>
             —  allows you to select product list for the module Featured. Available when Featured module is enabled or Product type option is set to Featured;
