...
<p align="justify">OpenCart — это многофункциональное, быстрое и понятное пользователю решение для электронной коммерции с
    ...
    модули и расширения для успешной торговли. Открытый исходный код предоставляет поистине выдающиеся возможности для
    Ваших клиентов.</p>
...
были ли модифицированы языковые файлы английского пака. Для этого зайдите в папки
